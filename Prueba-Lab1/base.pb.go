...
func (x *Actualizar) GetNombre() string {
	if x != nil {
		return x.Nombre
	}
	return ""
...
type CrearActualizacion struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Actualiza *Actualizar `protobuf:"bytes,1,opt,name=actualiza,proto3" json:"actualiza,omitempty"`
}

func (x *CrearActualizacion) Reset() {
	*x = CrearActualizacion{}
	if protoimpl.UnsafeEnabled {
...
func (x *CrearActualizacion) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CrearActualizacion) ProtoMessage() {}

func (x *CrearActualizacion) ProtoReflect() protoreflect.Message {
	mi := &file_proto_base_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CrearActualizacion.ProtoReflect.Descriptor instead.
func (*CrearActualizacion) Descriptor() ([]byte, []int) {
	return file_proto_base_proto_rawDescGZIP(), []int{7}
}

func (x *CrearActualizacion) GetActualiza() *Actualizar {
	if x != nil {
		return x.Actualiza
	}
	return nil
...
type RespuestaActualizacion struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Actualizaid string `protobuf:"bytes,1,opt,name=actualizaid,proto3" json:"actualizaid,omitempty"`
}

func (x *RespuestaActualizacion) Reset() {
	*x = RespuestaActualizacion{}
	if protoimpl.UnsafeEnabled {
...
func (x *RespuestaActualizacion) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RespuestaActualizacion) ProtoMessage() {}

func (x *RespuestaActualizacion) ProtoReflect() protoreflect.Message {
	mi := &file_proto_base_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RespuestaActualizacion.ProtoReflect.Descriptor instead.
func (*RespuestaActualizacion) Descriptor() ([]byte, []int) {
	return file_proto_base_proto_rawDescGZIP(), []int{8}
}

func (x *RespuestaActualizacion) GetActualizaid() string {
	if x != nil {
		return x.Actualizaid
	}
	return ""
}
...
var file_proto_base_proto_rawDesc = []byte{
	...
	,
...
var file_proto_base_proto_goTypes = []interface{}{
	...
	(*Actualizar)(nil),             // 6: grpc.Actualizar
	(*CrearActualizacion)(nil),     // 7: grpc.CrearActualizacion
	(*RespuestaActualizacion)(nil), // 8: grpc.RespuestaActualizacion
}
var file_proto_base_proto_depIdxs = []int32{
	...
	6, // 2: grpc.CrearActualizacion.actualiza:type_name -> grpc.Actualizar
	...
	7, // 5: grpc.MensajeService.CreateActualiza:input_type -> grpc.CrearActualizacion
	...
	8, // 8: grpc.MensajeService.CreateActualiza:output_type -> grpc.RespuestaActualizacion
...
func file_proto_base_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_base_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CrearActualizacion); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_base_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RespuestaActualizacion); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
